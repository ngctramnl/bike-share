...
setwd("D:/Google DA/Portfolio Building/2023-Casestudy1-Bike_share_program/CSV")
...
q1_2020 <- read_csv("Divvy_Trips_2020_Q1.original.csv")
...
write.csv(counts, file = 'D:/Google DA/Portfolio Building/2023-Casestudy1-Bike_share_program/CSV/avg_ride_length.csv')
