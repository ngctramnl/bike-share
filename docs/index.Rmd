...
### Remove lat, long, birthyear, and gender columns as this data was dropped beginning in 2020
...
all_trips <- all_trips %>%
  mutate(member_casual = recode(member_casual
                                ,"Subscriber"="member"
                                ,"Customer"="casual"))
table(all_trips$member_casual) #checks the proper number of observations were reassigned
...
```{r message=FALSE, warning=FALSE}
all_trips_v2 <- all_trips[!(all_trips$start_station_name == "HQ QR" | all_trips$ride_length<0),]  #creates a new version of the dataframe (v2) since data is being removed
...
### Create a csv file that we will visualize Tableau, or my presentation software
